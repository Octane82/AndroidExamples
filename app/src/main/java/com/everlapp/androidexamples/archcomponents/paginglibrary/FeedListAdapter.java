...
import com.everlapp.androidexamples.archcomponents.paginglibrary.utils.AppUtils;
import com.everlapp.androidexamples.archcomponents.paginglibrary.utils.NetworkState;
import com.everlapp.androidexamples.databinding.FeedItemBinding;
import com.everlapp.androidexamples.databinding.NetworkItemBinding;
...
public class FeedListAdapter extends PagedListAdapter<Article, RecyclerView.ViewHolder> {
    ...
    public class ArticleItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(Article article) {
            ...
            spannableString.setSpan(new ForegroundColorSpan(ContextCompat.getColor(context.getApplicationContext(), R.color.colorAccent)),
